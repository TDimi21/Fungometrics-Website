...
const buildOptionsFromSessions = (sessions) => {
  ...
  if (selected.includes('EV')) options.EV = TRAINING_OPTION_IDS.EV
  if (selected.includes('LT')) options.LT = TRAINING_OPTION_IDS.LT
  if (selected.includes('WB')) options.WB = TRAINING_OPTION_IDS.WB
