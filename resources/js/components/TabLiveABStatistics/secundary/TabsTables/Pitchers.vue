    ...
    <table class="w-full border-separate space-y-6 text-white">
      ...
      <tbody>
        ...
        <template v-if="!isBasic">
          <tr v-for="(item, index) in tableData['pitcher-basic'].players" :key="index" class="bg-app-card even:bg-white/[0.02] border-l border-white/5 relative">
        ...
        <template v-else>
          <tr v-for="(item, index) in tableData['pitcher-advance'].players" :key="index" class="bg-app-card even:bg-white/[0.02] border-l border-white/5 relative">
            <td class="w-[100px] lg:w-[250px] lg:max-w-[250px]">
              <div class="grid grid-cols-2 place-items-center w-[200px] lg:w-auto">
                <img
                  :src="getPlayerInfo(index).avatar"
