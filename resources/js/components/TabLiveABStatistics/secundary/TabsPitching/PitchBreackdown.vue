...
const getStrikePercentage = (items) => {
  ...
  sp =  ((strikecount * 100) / items.length).toFixed(2) ;
  strikePercentage.value = sp ? sp : 0;
}
  ...
  <section class="mt-5">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-7 lg:gap-x-8 mt-10 gap-y-8">
      <div class="flex flex-col space-y-5">
        <div class="bg-white rounded-r-[10px] border-l-2 border-fungo-red p-2 flex justify-evenly items-center">
          <span class="text-fungo-red">Strike</span>
          <span class="text-2xl font-fungo-700">{{ strikePercentage }}%</span>
        </div>
