...
export const DEFAULT_DRILL_LIBRARY = [
  ...
  // Timing
  { id: 'cage7', name: 'High Tee Challenge', category: 'Cage', skill: 'Timing', difficulty: 2, equipmentTags: ["Tee"], suggestedMinutes: 8, objective: 'Hit high fastballs while keeping the barrel above the ball — 3 rounds x 8 swings, middle/oppo focus.', equipment: 'Bat, tee, bucket of balls', coachingCues: 'Match plane early, don’t drop the hands, stay through it, finish tall' },
  ...
  { id: 'cage21', name: 'Two-Strike Approach', category: 'Cage', skill: 'Situational', difficulty: 3, equipmentTags: ["Front Toss"], suggestedMinutes: 8, objective: 'Choke up, widen the zone, battle and put it in play.', equipment: 'Front toss/machine, balls', coachingCues: 'Shorten up, fight, hit it where it’s pitched' },
