...
class GetTopTenWeightResultsTest extends TestCase
{
    use GrantsCreatedTeamAccess;
    public function test_get_dashboard_top_ten_weight_velocity_ok(): void
    {
    ...
    public function test_get_dashboard_top_ten_weight_velocity_range_ok(): void
    {
        $user = User::factory()->create([
            'type' => UserTypes::COACH->value
        ]);
