...
class SeasonArchiveDeliveryPrepAudit extends Command
{
    protected $signature = 'planner:season-archive-delivery-prep
        {teamId : Team id}
    ...
    protected $description = 'Audit FMTRX season archive delivery preparation payloads.';

    public function handle(SeasonArchiveDeliveryPrepService $service): int
    {
        $options = [
        ...
        $this->info('FMTRX SEASON ARCHIVE DELIVERY PREP');
